datablock AudioProfile(BNE_RPKFireLoopSound)
{
   filename    = "./Sounds/Fire/AK47/RPK_LP.wav";
...
{
	%obj.playAudio(0, BNE_RPKFireLoopSound);
    %obj.FireLoop = true;
...
function BNE_RPKImage::onEndLoop(%this, %obj, %slot)
{
...
function BNE_RPKIronsightImage::onEndLoop(%this, %obj, %slot)
{
    %obj.playAudio(0, %this.loopingEndSound);
    %obj.FireLoop = false;
}
